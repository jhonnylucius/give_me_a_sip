...
import 'package:app_netdrinks/utils/string_normalizer.dart'; // Adicionar import
...
class IngredientsSelector extends StatelessWidget {
  ...
  final RxList<String> filteredIngredients = <String>[].obs;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: Obx(() {
            final displayIngredients = searchController.text.isEmpty
                ...
                return Obx(() {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        var newSelection =
                            List<String>.from(selectedIngredients);
                        if (isSelected) {
